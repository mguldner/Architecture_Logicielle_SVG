...
public abstract class Drawing {
   ...
   * @param height of the desired drawing
   * @param width of the desired drawing
   */
  ...
  /*=======================================================*/
  /**
   * This method produces the final Java export, giving it the height and 
   * the width wanted by the user.
   * @param height of the desired drawing
   * @param width of the desired drawing
   */
  ...
  public abstract void generateJavaCode(Graphics2D graph);
}
