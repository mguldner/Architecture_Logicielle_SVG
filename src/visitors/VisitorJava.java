...
public class VisitorJava extends Visitor<Shape> {
  ...
  @Override
  public Visitor<Shape> visitOperator(Drawing<Shape>[] drawings, Object[] optionalParams) {
    if (optionalParams == null || optionalParams.length < 1 
        || ! (optionalParams[0] instanceof Graphics2D)) {
      throw new Error("No valid graphic given");
    }
  ...
  @Override
  public Visitor<Shape> visitLoop(Drawing<Shape>[] drawings, String change, Object[] changeparams, 
      Object[] optionalParams) {
    if (optionalParams == null || optionalParams.length < 1 
        || ! (optionalParams[0] instanceof Graphics2D)) {
      throw new Error("No valid graphic given");
